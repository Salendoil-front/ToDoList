const saveButtonRelax = document.querySelector('button.save-relax')
const clearButtonRelax = document.querySelector('button.clear-relax')
...
document.addEventListener('DOMContentLoaded', function () {
    const data = localStorage.getItem('todosKeyRelax')
    if (data) {
